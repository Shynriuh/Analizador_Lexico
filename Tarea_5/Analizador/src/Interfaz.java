...
public class Interfaz extends JFrame {
	...
	public Interfaz() {
		...
		lbl_arbol.setBounds(836, 72, 257, 20);
		...
		scroll_a.setBounds(857, 122, 216, 420);
		...
		separator_9.setBounds(836, 97, 257, 14);
		contentPane.add(separator_9);
		
		JSeparator separator_12 = new JSeparator();
		separator_12.setBounds(836, 566, 255, 14);
		contentPane.add(separator_12);
		
		JSeparator separator_10 = new JSeparator();
		separator_10.setOrientation(SwingConstants.VERTICAL);
		separator_10.setBounds(837, 97, 10, 471);
		contentPane.add(separator_10);
		
		JSeparator separator_11 = new JSeparator();
		separator_11.setOrientation(SwingConstants.VERTICAL);
		separator_11.setBounds(1092, 97, 10, 471);
